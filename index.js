        ...
        <div className="container">
          ...
          <nav className="navbar">
            <ul className="nav-menu">
              ...
              <li><CustomLink href="http://localhost:27017/index">Login</CustomLink></li>
            </ul>
        ...
        <div className="container">
          ...
          <div className="contact-details">
            <div className="contact-item">
              ...
              <p>
                <a href="https://wa.me/233264000000" target="_blank">
                  <Image
                    src="/images/whatsapp_icon.png"  // Image is inside public/images
                    alt="Send WhatsApp Message"
                    width={30} // Define width
                    height={30} // Define height
                  />
                </a>
              </p>
            </div>
            <div className="contact-item">
              ...
              <p>
                <a href="https://wa.me/233561555000" target="_blank">
                  <Image
                    src="/images/whatsapp_icon.png"  // Image is inside public/images
                    alt="Send WhatsApp Message"
                    width={30} // Define width
            ...
            <div className="contact-item">
              ...
              <p>
                ...
                <script src="/.src/.assests/.js/Kripa.js" defer></script>
              </p>
            </div>
          </div>
        </div>
